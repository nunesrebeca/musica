...
urlpatterns = [
    ...
    path('<int:pk>/', MusicaDetailView.as_view(), name='musica_detail'),
    path('<int:pk>/edit/', MusicaUpdateView.as_view(), name='musica_update'),
    path('<int:pk>/delete/', MusicaDeleteView.as_view(), name='musica_delete'),
