...
class MusicaListView(ListView):
    model = Musica
    success_url = 'musicas/musica_list.html'

class MusicaDetailView(DetailView):
    model = Musica
    template_nome = 'musicas/musica_detail.html'

class MusicaCreateView(CreateView):
    model = Musica
    form_class = MusicaForm
    template_nome = 'musicas/musica_form.html'
...
class MusicaDeleteView(DeleteView):
    model = Musica
    template_nome = 'musicas/musica_confirm_delete.html'
    success_url = reverse_lazy('musica_list')
